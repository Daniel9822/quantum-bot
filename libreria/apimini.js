...
const $ = cheerio.load(res.data)
const Wiki = []
let wikip = $('#mf-section-0').find('p').text()
let thumb = $('#mf-section-0').find('div > div > a > img').attr('src')
thumb = thumb ? thumb : '//pngimg.com/uploads/wikipedia/wikipedia_PNG35.png'
thumb = 'https:' + thumb
let title = $('h1#section_0').text()
Wiki.push({ wikip, thumb, title })
return Wiki
}
...
module.exports = { dlmediafire, wikipedia, pinterest, wallpaper, wikimedia, quotesAnime, aiovideodl, UploadFile, TelegraPh, webp2mp4File }
